    ...
    string shaderName)
{
    ...
    model = glm::translate(model, glm::vec3(position));
    model = glm::rotate(model, rotation.x, glm::vec3(0.1f, 0.0f, 0.0f));
    model = glm::rotate(model, rotation.y, glm::vec3(0.0f, 0.1f, 0.0f));
    model = glm::rotate(model, rotation.z, glm::vec3(0.0f, 0.0f, 0.1f));
    model = glm::scale(model, glm::vec3(scale, scale, scale));
